...
<div class="gallery">
  <figure>
    <img src="<?php echo base_url('asset/images/corregir/IMG_0331.JPG')?>" alt="<?php echo base_url('asset/images/corregir/IMG_0331.JPG')?>" />
...
<?php $this->load->view('utilidad/footer.php'); ?>